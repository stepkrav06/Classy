...
let nextLessonSnapshotEntry = NextLessonWidgetContent(lesson: Lesson(name: "Class", timeStart: "10:00", timeEnd: "11:00", colorR: 0, colorG: 0.7, colorB: 0.7, colorA: 1), nextDate: Date(timeIntervalSinceNow: 60 * 60))
...
struct NextLessonProvider: TimelineProvider {
    ...
    func getSnapshot(in context: Context, completion: @escaping (NextLessonWidgetContent) -> ()) {
        completion(nextLessonSnapshotEntry)
    }
